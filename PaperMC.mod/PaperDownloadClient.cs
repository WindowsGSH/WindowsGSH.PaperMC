...
public sealed class PaperDownloadClient : IDisposable
{
    ...
    private static HttpClient CreateSharedHttpClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("WindowsGSH", "0.1.0"));
        client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("(https://github.com/shenniko/WindowsGSH)"));
        return client;
    }
